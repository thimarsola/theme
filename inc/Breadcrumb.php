    ...
    if (!is_front_page()) {
        ...
        if (is_archive() && !is_tax() && !is_category() && !is_tag()) {
            ...
            if ($post_type != 'post') {
                ...
                echo '<li class="item-cat item-custom-post-type-' . $post_type . '"><a class="' . $style . ' bread-custom-post-type-' . $post_type . '" href="' . $post_type_archive . '" title="' . $post_type_object->labels->name . '">' . $post_type_object->labels->name . '</a></li>';
            ...
            if ($post->post_parent) {
                ...
                foreach ($anc as $ancestor) {
                    $parents .= '<li class="item-parent item-parent-' . $ancestor . '"><a class="' . $style . ' bread-parent-' . $ancestor . '" href="' . get_permalink($ancestor) . '" title="' . get_the_title($ancestor) . '">' . get_the_title($ancestor) . '</a></li>';
            ...
            // Year link
            echo '<li class="item-year item-year-' . get_the_time('Y') . '"><a class="' . $style . ' bread-year-' . get_the_time('Y') . '" href="' . get_year_link(get_the_time('Y')) . '" title="' . get_the_time('Y') . '">' . get_the_time('Y') . ' Archives</a></li>';
