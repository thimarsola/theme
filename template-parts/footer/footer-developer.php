    ...
    <div class="container">
        ...
        <div class="footer__developer__row flex justify-between items-center flex-wrap gap-1">
            ...
            <div class="footer__developer__row__agency text-center">
                <p>Desenvolvido por <a rel="nofollow noreferrer noopener" href="<?php echo DEV['url']; ?>"
                                       target="_blank" class="link-primary-300 font-medium" title="Agência 
            ...
            <?php if ( ! is_404() ) : ?>
                <div class="footer__developer__row__validator">
                    <a rel="nofollow noreferrer noopener" class="link-primary-300 leading-none text-center"
