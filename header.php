...
<head>
	...
	<link
		href="https://fonts.googleapis.com/css2?family=Lato:wght@400;700&family=Lora:wght@400;600&display=swap"
		rel="stylesheet">
...
<!-- whatsapp -->
	<?php get_template_part( 'template-parts/header/content', 'whatsapp' ); ?>
<!-- end of whatsapp -->
